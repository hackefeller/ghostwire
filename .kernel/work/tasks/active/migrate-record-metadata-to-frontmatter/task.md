...
checklist:
  - id: define-frontmatter-schema
    title: Define the frontmatter schema for goals, tasks, knowledge, and
      learnings
    done: true
...
- [ ] Goal, task, and knowledge records store metadata in markdown frontmatter.
...
- [x] Define the frontmatter schema for goals, tasks, knowledge, and learnings
...
- 2026-05-05T19:18:47.000Z: Defined the frontmatter schema types for goals, tasks, knowledge, and learnings.
