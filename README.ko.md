...
>
> ✅ 공식 다운로드: https://github.com/code-yeongyu/ruach/releases
...
> [!TIP]
>
> [![Ruach 3.0 정식 출시!](./.github/assets/orchestrator-atlas.png?v=3)](https://github.com/code-yeongyu/ruach/releases/tag/v3.0.0)
> > **Ruach 3.0이 정식 출시되었습니다! `ruach@latest`를 사용하여 설치하세요.**
>
> 함께해요!
>
...
> 이것은 코딩을 스테로이드로 만드는 것 — 실제로 작동하는 `ruach`입니다. 백그라운드 에이전트 실행, 오라클, 라이브러리언, 프론트엔드 엔지니어와 같은 전문 에이전트 호출. 정교하게 제작된 LSP/AST 도구, 큐레이팅된 MCP, 완전한 Claude Code 호환 계층 사용.
...
- [Claude OAuth 액세스 공지](#claude-oauth-액세스-공지)
  - [TL;DR](#tldr)
  - [FULL](#full)
  - [리뷰](#리뷰)
  - [목차](#목차)
