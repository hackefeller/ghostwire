...
|----------|----------|-------|----------|
| **P0** | Agents | 7 | agent-native-reviewer, architecture-strategist, security-sentinel, performance-oracle, code-simplicity-reviewer, data-integrity-guardian, deployment-verification-agent |
...
- All imported components prefixed with namespace (`compound:`)
...
- Agent factory pattern: `src/agents/oracle.ts`
- Hook factory pattern: `src/hooks/context-window-monitor/`
