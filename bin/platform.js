 ...
 * @returns {string} Package name like "ruach-darwin-arm64"
 ...
 * @returns {string} Relative path like "ruach-darwin-arm64/bin/ruach"
 */
export function getBinaryPath(pkg, platform) {
  const ext = platform === "win32" ? ".exe" : "";
  return `${pkg}/bin/ruach${ext}`;
}
