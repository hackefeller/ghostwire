...
This document provides a comprehensive guide to the orchestration system that implements Ruach's core philosophy: **"Separation of Planning and Execution"**.
...
Ruach solves this by clearly separating two roles:
...
You can control related features in `ruach.json`.
