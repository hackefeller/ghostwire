...
Ghostwire's orchestration system transforms a simple AI agent into a coordinated development team. This document explains how the Augur Planner → Nexus Orchestrator → Junior workflow creates high-quality, reliable code output.
...
flowchart TB
    subgraph Planning["Planning Layer (Human + Augur Planner)"]
        User[("👤 User")]
        Augur Planner["🔥 Augur Planner<br/>(Planner)<br/>Claude Opus 4.5"]
        Tactician Strategist["🦉 Tactician Strategist<br/>(Consultant)<br/>Claude Opus 4.5"]
        Glitch Auditor["👁️ Glitch Auditor<br/>(Reviewer)<br/>GPT-5.2"]
    end
    
    subgraph Execution["Execution Layer (Orchestrator)"]
        Orchestrator["⚡ Nexus Orchestrator<br/>(Conductor)<br/>Claude Opus 4.5"]
    end
    
    subgraph Workers["Worker Layer (Specialized Agents)"]
        Junior["🪨 Cipher Operator-Junior<br/>(Task Executor)<br/>Claude Sonnet 4.5"]
        Seer Advisor["🧠 Seer Advisor<br/>(Architecture)<br/>GPT-5.2"]
        Scout Recon["🔍 Scout Recon<br/>(Codebase Grep)<br/>Grok Code"]
        Archive Researcher["📚 Archive Researcher<br/>(Docs/OSS)<br/>GLM-4.7"]
...
## Layer 1: Planning (Augur Planner + Tactician Strategist + Glitch Auditor)
...
Augur Planner adapts its interview style based on what you're doing:
...
**Why Tactician Strategist Exists:**

The plan author (Augur Planner) has "ADHD working memory" - it makes connections that never make it onto the page. Tactician Strategist forces externalization of implicit knowledge.
...
## Layer 2: Execution (Nexus Orchestrator)
...
This "boulder pushing" mechanism is why the system is named after Cipher Operator.
...
sequenceDiagram
    participant User
    participant Orchestrator as Nexus Orchestrator
    participant Junior as Cipher Operator-Junior
    participant Notepad as .ghostwire/notepads/
    
    User->>Orchestrator: /jack-in-work
...
1. **Enter Augur Planner Mode**: Press **Tab** at the prompt
2. **Describe Your Work**: "I want to add user authentication to my app"
3. **Answer Interview Questions**: Augur Planner will ask about patterns, preferences, constraints
4. **Review the Plan**: Check `.ghostwire/plans/` for generated work plan
5. **Run `/jack-in-work`**: Orchestrator takes over
...
- [Overview](../getting-started/overview.md) - Quick start guide
- [Ultrawork Manifesto](./ultrawork-manifesto.md) - Philosophy behind the system
- [Installation Guide](../getting-started/installation.md) - Detailed installation instructions
- [Configuration](../reference/configurations.md) - Customize the orchestration
