...
This document provides a comprehensive guide to the **Category** and **Skill** systems, which form the extensibility core of Ruach.
...
## 6. Configuration Guide (ruach.json)

You can fine-tune categories in `ruach.json`.
