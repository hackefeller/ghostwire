...
\`\`\`typescript
delegate_task(subagent_type="scout-recon", run_in_background=true, ...)
delegate_task(subagent_type="archive-researcher", run_in_background=true, ...)
\`\`\`
...
- Notepad: \`.ghostwire/notepads/{name}/\` (READ/APPEND)
</notepad_protocol>
