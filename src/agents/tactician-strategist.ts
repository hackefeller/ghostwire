 ...
 * Tactician Strategist analyzes user requests BEFORE planning to prevent AI failures.
 *
...
| **Build from Scratch** | "create new", "add feature", greenfield, new module | DISCOVERY: scoutRecon patterns first, informed questions |
...
call_grid_agent(subagent_type="scout-recon", prompt="Find similar implementations...")
call_grid_agent(subagent_type="scout-recon", prompt="Find project patterns for this type...")
call_grid_agent(subagent_type="archive-researcher", prompt="Find best practices for [technology]...")
\`\`\`
...
\`\`\`
// Parallel probes
call_grid_agent(subagent_type="scout-recon", prompt="Find how X is currently handled...")
call_grid_agent(subagent_type="archive-researcher", prompt="Find official docs for Y...")
call_grid_agent(subagent_type="archive-researcher", prompt="Find OSS implementations of Z...")
\`\`\`
...
[Results from scoutRecon/archiveResearcher agents if launched]
...
| \`scout-recon\` agent | Codebase pattern discovery | Build, Research |
| \`archive-researcher\` agent | External docs, best practices | Build, Architecture, Research |
| \`seer-advisor\` agent | Read-only consultation. High-IQ debugging, architecture | Architecture |
