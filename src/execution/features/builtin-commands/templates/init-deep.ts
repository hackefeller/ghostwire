...
delegate_task(agent="scan-ops", prompt="Project structure: PREDICT standard patterns for detected language → REPORT deviations only")
delegate_task(agent="scan-ops", prompt="Entry points: FIND main files → REPORT non-standard organization")
delegate_task(agent="scan-ops", prompt="Conventions: FIND config files (.eslintrc, pyproject.toml, .editorconfig) → REPORT project-specific rules")
delegate_task(agent="scan-ops", prompt="Anti-patterns: FIND 'DO NOT', 'NEVER', 'ALWAYS', 'DEPRECATED' comments → LIST forbidden patterns")
delegate_task(agent="scan-ops", prompt="Build/CI: FIND .github/workflows, Makefile → REPORT non-standard patterns")
delegate_task(agent="scan-ops", prompt="Test patterns: FIND test configs, test structure → REPORT unique conventions")
\`\`\`
...
delegate_task(agent="scan-ops", prompt="Large file analysis: FIND files >500 lines, REPORT complexity hotspots")
delegate_task(agent="scan-ops", prompt="Deep modules at depth 4+: FIND hidden patterns, internal conventions")
delegate_task(agent="scan-ops", prompt="Cross-cutting concerns: FIND shared utilities across directories")
