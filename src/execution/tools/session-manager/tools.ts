...
export const session_create: ToolDefinition = tool({
  ...
  args: {
    ...
    parent_session_id: tool.schema
      .string()
      .optional()
      .describe("Parent session ID (creates child session)"),
    initial_prompt: tool.schema
      .string()
      .optional()
      .describe("Initial message/prompt for the session"),
  },
...
export const session_delete: ToolDefinition = tool({
  ...
  args: {
    ...
    cascade: tool.schema
      .boolean()
      .optional()
      .describe("If true, recursively delete child sessions (default: false)"),
    force: tool.schema
      .boolean()
      .optional()
      .describe("If true, bypass safety checks (default: false)"),
    archive_todos: tool.schema
      .boolean()
      .optional()
      .describe("If true, archive todos instead of deleting (default: true)"),
