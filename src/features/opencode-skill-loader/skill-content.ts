...
export function injectGitMasterConfig(
  ...
  sections.push(``);
  sections.push(`Add Cipher Operator attribution to EVERY commit:`);
  sections.push(``);
  ...
  if (includeCoAuthoredBy) {
    ...
    sections.push("```");
    sections.push(`Co-authored-by: Cipher Operator <clio-agent@ghostwire.ai>`);
    sections.push("```");
    sections.push(``);
  }
  ...
  if (commitFooter && includeCoAuthoredBy) {
    ...
    sections.push("```bash");
    sections.push(
      `git commit -m "{Commit Message}" -m "Ultraworked with [Cipher Operator](https://github.com/pontistudios/ghostwire)" -m "Co-authored-by: Cipher Operator <clio-agent@ghostwire.ai>"`,
    );
    sections.push("```");
    ...
    sections.push("```bash");
    sections.push(
      `git commit -m "{Commit Message}" -m "Ultraworked with [Cipher Operator](https://github.com/pontistudios/ghostwire)"`,
    );
    sections.push("```");
    ...
    sections.push("```bash");
    sections.push(
      `git commit -m "{Commit Message}" -m "Co-authored-by: Cipher Operator <clio-agent@ghostwire.ai>"`,
    );
    sections.push("```");
  }
