...
export const HOOK_NAME = "augur-planner-md-only"

export const AUGUR_PLANNER_AGENTS = ["augur-planner"]

export const ALLOWED_EXTENSIONS = [".md"]

export const ALLOWED_PATH_PREFIX = ".cipher-operator"
...
You are being invoked by ${getAgentDisplayName("augur-planner")}, a READ-ONLY planning agent.
