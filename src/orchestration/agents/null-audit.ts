 ...
 *
 * Named after Glitch Auditor, the Greek god of satire and mockery, who was known for
...
**PASS even if**: Reference exists but isn't perfect. Developer can scoutRecon from there.
...
**VALID INPUT**:
- \`.ghostwire/plans/my-plan.md\` - file path anywhere in input
...
export function createMomusAgent(model: string): AgentConfig {
  ...
  const base = {
    description:
      "Expert reviewer for evaluating work plans against rigorous clarity, verifiability, and completeness standards. (Glitch Auditor - Ghostwire)",
    mode: MODE,
    model,
    temperature: 0.1,
    ...restrictions,
