...
const SECURITY_REVIEWER_PROMPT = `You are an elite Application Security Specialist with deep expertise in identifying and mitigating security vulnerabilities. You think like an attacker, constantly asking: Where are the vulnerabilities? What could go wrong? How could this be exploited?
...
export function createSecurityReviewerAgent(model: string): AgentConfig {
  ...
  return {
    description:
      "Security audits, vulnerability assessments, and security reviews of code. Checks for common security vulnerabilities, validates input handling, reviews authentication/authorization implementations, scans for hardcoded secrets, and ensures OWASP compliance.",
    model,
    temperature: 0.1,
...
export const SECURITY_REVIEWER_METADATA: AgentPromptMetadata = {
  category: "review",
  cost: "HIGH",
