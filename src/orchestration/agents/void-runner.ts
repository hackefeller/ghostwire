...
| **Exploratory** | "How does X work?", "Find Y" | Fire scoutRecon (1-3) + tools in parallel |
...
result = delegate_task(..., run_in_background=false)  // Never wait synchronously for scoutRecon/archiveResearcher
\`\`\`
...
**DO NOT over-scoutRecon. Time is precious.**
