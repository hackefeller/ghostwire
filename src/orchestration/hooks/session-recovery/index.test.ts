...
describe("detectErrorType", () => {
  describe("thinking_block_order errors", () => {
    ...
    it("should detect 'final block cannot be thinking' error pattern", () => {
      ...
      const error = {
        message: "messages.125: The final block in an assistant message cannot be thinking.",
      };
    ...
    it("should detect 'final block' variant error pattern", () => {
      ...
      const error = {
        message: "messages.17: thinking in the final block is not allowed in assistant messages",
      };
    ...
    it("should detect 'cannot be thinking' error pattern", () => {
      ...
      const error = {
        message: "messages.219: The last block in an assistant message cannot be thinking content",
      };
  ...
  describe("thinking_disabled_violation errors", () => {
    it("should detect thinking disabled violation", () => {
      ...
      const error = {
        message: "thinking is disabled for this model and cannot contain thinking blocks",
      };
  ...
  describe("nested error objects", () => {
    it("should detect error in data.error.message path", () => {
      ...
      const error = {
        data: {
          error: {
            message: "messages.163: The final block in an assistant message cannot be thinking.",
          },
        },
      };
