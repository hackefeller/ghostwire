 ...
 */
function createMockInput(providerID: string, modelID: string, promptText: string): ThinkModeInput {
  return {
...
describe("createThinkModeHook integration", () => {
  ...
  describe("GitHub Copilot provider integration", () => {
    describe("Claude models", () => {
      it("should activate thinking mode for github-copilot Claude with think keyword", async () => {
        ...
        expect((message.thinking as Record<string, unknown>)?.budgetTokens).toBe(64000);
      });
      ...
      it("should handle github-copilot Claude with dots in version", async () => {
        ...
        const hook = createThinkModeHook();
        const input = createMockInput("github-copilot", "claude-opus-4.5", "ultrathink mode");
      ...
      it("should handle github-copilot Claude Sonnet", async () => {
        ...
        const hook = createThinkModeHook();
        const input = createMockInput("github-copilot", "claude-sonnet-4-5", "think about this");
    ...
    describe("Gemini models", () => {
      it("should activate thinking mode for github-copilot Gemini Pro", async () => {
        ...
        const hook = createThinkModeHook();
        const input = createMockInput("github-copilot", "gemini-3-pro", "think about this");
        ...
        const googleOptions = (message.providerOptions as Record<string, unknown>)
      ...
      it("should activate thinking mode for github-copilot Gemini Flash", async () => {
        ...
        const hook = createThinkModeHook();
        const input = createMockInput("github-copilot", "gemini-3-flash", "ultrathink");
    ...
    describe("GPT models", () => {
      it("should activate thinking mode for github-copilot GPT-5.2", async () => {
        ...
        const hook = createThinkModeHook();
        const input = createMockInput("github-copilot", "gpt-5.2", "please think");
    ...
    describe("No think keyword", () => {
      it("should NOT activate for github-copilot without think keyword", async () => {
        ...
        const hook = createThinkModeHook();
        const input = createMockInput("github-copilot", "claude-opus-4-5", "Just do this task");
  ...
  describe("Backwards compatibility with direct providers", () => {
    it("should still work for direct anthropic provider", async () => {
      ...
      const hook = createThinkModeHook();
      const input = createMockInput("anthropic", "claude-sonnet-4-5", "think about this");
    ...
    it("should still work for direct google provider", async () => {
      ...
      const hook = createThinkModeHook();
      const input = createMockInput("google", "gemini-3-pro", "think about this");
    ...
    it("should still work for amazon-bedrock provider", async () => {
      ...
      const hook = createThinkModeHook();
      const input = createMockInput("amazon-bedrock", "claude-sonnet-4-5", "think");
  ...
  describe("Already-high variants", () => {
    it("should NOT re-upgrade already-high variants", async () => {
      ...
      const hook = createThinkModeHook();
      const input = createMockInput("github-copilot", "claude-opus-4-5-high", "think deeply");
    ...
    it("should NOT re-upgrade already-high GPT variants", async () => {
      ...
      const hook = createThinkModeHook();
      const input = createMockInput("github-copilot", "gpt-5.2-high", "ultrathink");
  ...
  describe("Unknown models", () => {
    it("should not crash for unknown models via github-copilot", async () => {
      ...
      const hook = createThinkModeHook();
      const input = createMockInput("github-copilot", "llama-3-70b", "think about this");
  ...
  describe("Edge cases", () => {
    it("should handle missing model gracefully", async () => {
      ...
      await expect(hook["chat.params"](input, sessionID)).resolves.toBeUndefined();
    });
