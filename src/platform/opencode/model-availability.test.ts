...
describe("fuzzyMatchModel", () => {
  ...
  it("should match preview suffix for gemini-3-flash", () => {
    ...
    const result = fuzzyMatchModel("google/gemini-3-flash", available, ["google"]);
  ...
  it("should prefer exact match over substring match", () => {
    const available = new Set(["openai/gpt-5.2", "openai/gpt-5.2-codex", "openai/gpt-5.2-ultra"]);
    const result = fuzzyMatchModel("gpt-5.2", available);
    expect(result).toBe("openai/gpt-5.2");
  });
  ...
  it("should prefer shorter model name when multiple matches exist", () => {
    const available = new Set(["openai/gpt-5.2-ultra", "openai/gpt-5.2-ultra-mega"]);
    const result = fuzzyMatchModel("gpt-5.2", available);
  ...
  it("should match claude-opus to claude-opus-4-5", () => {
    const available = new Set(["anthropic/claude-opus-4-5", "anthropic/claude-sonnet-4-5"]);
  ...
  it("should filter by provider when providers array is given", () => {
    const available = new Set(["openai/gpt-5.2", "anthropic/claude-opus-4-5", "google/gemini-3"]);
  ...
  it("should return null when provider filter excludes all matches", () => {
    const available = new Set(["openai/gpt-5.2", "anthropic/claude-opus-4-5"]);
  ...
  it("should prioritize exact match over longer variants", () => {
    const available = new Set(["anthropic/claude-opus-4-5", "anthropic/claude-opus-4-5-extended"]);
