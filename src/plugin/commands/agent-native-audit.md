...
```
/ghostwire:agent-native-architecture
```
...
Launch 8 parallel sub-agents using the Task tool with `subagent_type: Scout Recon`, one for each principle. Each agent should:
